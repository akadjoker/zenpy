# Zen-only variant of py/gamebench.py with type hints: class-body field
# annotations turn field reads into checked-index access and method calls
# into vtable dispatch, which is how engine code would actually be written.
#
