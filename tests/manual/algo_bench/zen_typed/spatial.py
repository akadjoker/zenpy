# Zen-only variant of py/spatial.py with type hints: class-body field
# annotations (c0: Quad?) make child.query()/insert() vtable calls and
# node.x checked-index field reads.
import time
